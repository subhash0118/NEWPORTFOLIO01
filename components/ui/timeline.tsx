  ...
  return (
    <div className="w-full bg-transparent font-sans md:px-10" ref={containerRef}>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-10">
        {data.map((item, index) => (
          <div key={index + "-" + item.title} className="flex justify-start pt-5 md:pt-20 md:gap-10">
        ...
        >
          <motion.div
            ...
            className="absolute left-0 top-0 w-[2px] bg-gradient-to-t from-purple-500 via-blue-500 to-transparent from-[0%] via-[10%] rounded-full dark:via-blue-400"
          />
        </div>
      </div>
    </div>
